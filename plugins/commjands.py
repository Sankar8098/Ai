...
async def start(client, message):
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for msg in msgs:
            ...
            try:
                ...
                filesarr.append(msg)
                k = await client.send_message(chat_id = message.from_user.id, text=f"<b><u>❗️❗️❗️IMPORTANT❗️️❗️❗️</u></b>\n\nThis Movie Files/Videos will be deleted in <b><u>10 mins</u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>Please forward this ALL Fies/Videos to your Saved Messages and Start Download there</i></b> /n/n<b><u>❗️❗️❗️முக்கியமானது❗️️❗️❗️</u></b>\n\nஇந்த மூவி கோப்பு/வீடியோ <b><u>10 நிமிடங்களில் நீக்கப்படும் </u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>இந்த அனைத்து Files/வீடியோக்களையும் உங்கள் சேமித்த செய்திகளுக்கு அனுப்பி, அங்கே பதிவிறக்கத்தை தொடங்கவும் there</i></b>")
            ...
            await asyncio.sleep(1) 
        await sts.delete()
        k = await client.send_message(chat_id = message.from_user.id, text=f"<b><u>❗️❗️❗️IMPORTANT❗️️❗️❗️</u></b>\n\nThis Movie Files/Videos will be deleted in <b><u>10 mins</u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>Please forward this ALL Files/Videos to your Saved Messages and Start Download there</i></b> /n/n<b><u>❗️❗️❗️முக்கியமானது❗️️❗️❗️</u></b>\n\nஇந்த மூவி கோப்பு/வீடியோ <b><u>10 நிமிடங்களில் நீக்கப்படும் </u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>இந்த அனைத்து Files/வீடியோக்களையும் உங்கள் சேமித்த செய்திகளுக்கு அனுப்பி, அங்கே பதிவிறக்கத்தை தொடங்கவும் there</i></b>")
        await asyncio.sleep(600)
        for x in filesarr:
            await x.delete()
        await k.edit_text("<b>Your All Files/Videos is successfully deleted!!!</b>")       
    ...
    if not files_:
        ...
        try:
            ...
            title = '@SK_MoviesOffl  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
            ...
            k = await msg.reply("<b><u>❗️❗️❗️IMPORTANT❗️️❗️❗️</u></b>\n\nThis Movie File/Video will be deleted in <b><u>10 mins</u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>Please forward this File/Video to your Saved Messages and Start Download there</i></b> /n/n<b><u>❗️❗️❗️முக்கியமானது❗️️❗️❗️</u></b>\n\nஇந்த மூவி கோப்பு/வீடியோ <b><u>10 நிமிடங்களில் நீக்கப்படும் </u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>இந்த அனைத்து Files/வீடியோக்களையும் உங்கள் சேமித்த செய்திகளுக்கு அனுப்பி, அங்கே பதிவிறக்கத்தை தொடங்கவும் there</i></b>",quote=True)
            await asyncio.sleep(600)
            await msg.delete()
